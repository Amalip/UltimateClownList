...
fun Context.coloredShortToast(message: Int, backgroundColor: Int, textColor: Int) {
    showColoredToast(this, getString(message), backgroundColor, textColor, Toast.LENGTH_SHORT)
}
...
fun Context.coloredLongToast(message: Int, backgroundColor: Int, textColor: Int) {
    showColoredToast(this, getString(message), backgroundColor, textColor, Toast.LENGTH_SHORT)
}
...
private fun showColoredToast(
    ...
    try {
        ...
        view.background = ContextCompat.getDrawable(context, R.drawable.view_toast_bg)
